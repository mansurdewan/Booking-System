    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                server = app_1.default.listen(process.env.PORT, function () {
                    console.log("The app is listing ".concat(process.env.PORT));
                });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
...
process.on("unhandledRejection", function (promise, error) {
    console.log("unhandledRejection detected :" + promise + "the error is:" + error);
    if (server) {
        server.close();
        process.exit(1);
    }
